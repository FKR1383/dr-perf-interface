# Compare UTF-16 backreference without case sensitivity
...
Suggested bounded workload: Execute a case-insensitive UTF-16 backreference comparison of bounded length.
